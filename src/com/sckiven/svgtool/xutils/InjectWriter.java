...
public class InjectWriter extends WriteCommandAction.Simple {
    ...
    public void run() throws Throwable {
        final IXUtils butterKnife = XUtilsFactory.findXUtilsForPsiElement(mProject, mFile);
        if (butterKnife == null) {
     ...
     */
    protected void generateAdapter(@NotNull IXUtils butterKnife) {
        // view holder class
...
//        mClass.addBefore(mFactory.createCommentFromText(comment.toString(), mClass), mClass.findInnerClassByName(Utils.getViewHolderClassName(), true));
     ...
     */
    protected void generateFields(@NotNull IXUtils butterKnife) {
    ...
    protected void generateInjects(@NotNull IXUtils butterKnife) {
    ...
    private void generateActivityBind(@NotNull IXUtils butterKnife) {
    ...
    private void generateFragmentBindAndUnbind(@NotNull IXUtils butterKnife) {
    ...
    private static StringBuilder generateUnbindStatement(@NotNull IXUtils butterKnife, String unbinderName,
     ...
     */
    private String getNameForUnbinder(@NotNull IXUtils butterKnife) {
