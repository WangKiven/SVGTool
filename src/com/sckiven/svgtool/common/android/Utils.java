package com.sckiven.svgtool.common.android;
...
import com.sckiven.svgtool.xutils.Settings;
...
public class Utils {
     ...
     * 适用与java和kotlin文件
     */
    public static PsiFile getLayoutFileFromCaret(Project project, Editor editor, PsiFile psiFile) {
     ...
     * @return
     */
    public static String getInjectionID(@NotNull IXUtils butterKnife, String annotation) {
        String id = null;
